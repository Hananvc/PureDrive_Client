...
export function Images() {
  ...
  const handleImageEditModalOpen = ({ id, images }) => {
    setSelectedImages(images);
    setSelectedVehicleId(id);
    setIsImageEditModalOpen(true);
  };

  const handleImageEdit = (editedImages) => {
    // Send the editedImages to your backend API for updating
    // You can also update the images state if needed
    // ...
          ...
          <table className="w-full min-w-max table-auto text-left">
            ...
            <tbody>
              {vehicles.map((vehicle) => (
                ...
                <td className="p-4 border-b border-blue-gray-50">
                  <button
                    onClick={() => handleImageEditModalOpen({ id: vehicle.id, images: vehicle.images })}
